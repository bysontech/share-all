  ...
  return (
    <div style={outerStyle}>
      <div style={headerStyle}>
        <Link to={`/room/${roomId}`} style={{ fontSize: 13, color: accentColor, textDecoration: 'none' }}>
          ← 戻る
        </Link>
      ...
      <div style={bodyStyle}>
        ...
        {posts.length > 0 && (
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8, marginBottom: 16 }}>
            ...
            <button style={secondaryBtn} onClick={selectUnsaved} disabled={unsavedCount === 0}>
              未保存のみ選択 ({unsavedCount})
            </button>
            <div style={{ flex: 1 }} />
            <button
            ...
            <button
              style={!isDownloading ? primaryBtn : disabledBtn}
